...
class FileConfiguration implements Configuration, Registry<string> {
...
class ValOpt<T> implements Optional<T> {
    value: T | null;
...
class JsonFileMap extends FileConfiguration {
...
export {FileConfiguration, ValOpt, YamlConfiguration, JsonFileMap};